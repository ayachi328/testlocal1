...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'E:\p10\Développez un chatbot pour réserver des vacances\Ayachi_Ahmed_4_bot_app_072022\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'E:\p10\Développez un chatbot pour réserver des vacances\Ayachi_Ahmed_4_bot_app_072022\venv\Scripts\deactivate.nu'
